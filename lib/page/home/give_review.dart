...
class GiveReview extends StatefulWidget {
  bool isDrawer;
   GiveReview({super.key,required this.isDrawer});
  ...
  Widget build(BuildContext context) {
            ...
            child: Column(
              ...
              children: [
                ...
                widget.isDrawer?  InkWell(
                  ...
                  SizedBox(height: 3.h),
                  Center(child: Image.asset("assets/icons/rev.png",height: 12.h,)),
                  SizedBox(height: 2.h),

    Center(
      child: text_widget("Add Review"),
    ),
                  SizedBox(height: 2.h),
   ...
   onRatingUpdate: (rating) {
     print(rating);
         ...
         textFieldWithPrefixSuffuxIconAndHintText("Type here..",radius: 34,
