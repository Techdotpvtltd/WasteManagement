    ...
    return Scaffold(  
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          width: 100.w,
          child: Center(
            child: text_widget("+ Create a New Special Request ",
            fontSize: 16.sp,
            color: Color(0xff761E37),
            ),
          ),
            ...
            ...List.generate(6, (index) =>    Padding(
              ...
              child: Container(
                  decoration: BoxDecoration(
                    color:index==1?Color(0xffEFEFEF):  Color(0xffFCF3F1),
                    borderRadius: BorderRadius.circular(21)
                  ),
                   child: Padding(
                        padding: const EdgeInsets.all(4.0),
                        child: ListTile(
                          leading:Image.asset("assets/icons/req.png",height: 3.h),
                          title: text_widget("10:43pm ",
                           color:index==1?Color(0xff515151): MyColors.primary,
                          fontSize: 14.5.sp,
                          fontWeight: FontWeight.w700
                          ),
                          subtitle: Column(
                            children: [
                              text_widget("Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,",
                                color:index==1?Color(0xff515151): Color(0xff761E37),
                              fontSize: 14.5.sp,
                                ...
                                onTap: (){
                                 ...
                                 child: Container(
                                     ...
                                     child: Row(
                                      ...
                                      text_widget("View Response",
                                                fontSize: 13.sp,
                                                color: Colors.white
                                                ),
                                         Spacer(),
                                         CircleAvatar(radius: 2.2.h,
                                  ...
                                  Container(
                                    ...
                                    child: Center(
                                      child: text_widget("Waiting For Response",
                                                fontSize: 12.6.sp,
                                                color: Colors.white
                                                ),
                                    ),
