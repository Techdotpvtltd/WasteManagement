            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 3.h),
                    textWidget("Fill the information",
                        fontSize: 15.6.sp, fontWeight: FontWeight.w600),
                    SizedBox(height: 3.h),
                    ...
                    SizedBox(height: 2.h),
                    textFieldWithPrefixSuffuxIconAndHintText("Type Message",
                        radius: 34,
                        fillColor: Color(0xffF8F8F8),
                        bColor: Color(0xffE8ECF4),
                        hintColor: Color(0xff000000).withOpacity(0.40),
